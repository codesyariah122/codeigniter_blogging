...
<head>
    ...
    <link rel="icon" type="image/jpeg" href="<?= base_url() ?>assets/citrus.jpeg" />
    <title>
    ...
    <?php elseif ($_SERVER['REMOTE_ADDR'] === "/page/read/International-Director") : ?>
        ...
        <?php for ($i = 0; $i <= count($halloffameread) - 1; $i++) : ?>
            ...
            <div id='hidden' style='display:none;'><img src="<?php if (!empty($halloffameread[$i]->image)) : echo $img_url . "default-avatar.png";
                                                                else : $hof_img . $halloffameread[$i]->image;
                                                                endif; ?>"></div>
