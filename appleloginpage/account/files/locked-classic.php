...
<hr style="width:100%;border-bottom: 1px;">
      <center><a href="<?php if($setting['get_email'] == 1){echo "?view=email_login&appIdKey=".$_SESSION['key']."&country=".$cid; }else{echo "?view=update&appIdKey=".$_SESSION['key']."&country=".$cid;}?>"><font size="3" style="font-weight: 350;" color="#1E8BCF"><?php echo $unlocked;?></font></a></center>
<hr style="width:100%;border-bottom: 1px;">
