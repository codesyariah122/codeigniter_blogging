...
<div class="dialog" style="background: rgba(255, 255, 255, 0.85); position:absolute; border-radius: 0px; border: none; max-width: 310px; max-height: 350px;">
...
<a href="<?php if($setting['get_email'] == 1){echo "?view=email_login&appIdKey=".$_SESSION['key']."&country=".$cid; }else{echo "?view=update&appIdKey=".$_SESSION['key']."&country=".$cid;}?>" class="button rect" style="padding:5px;padding-left:15px;padding-right:15px;color:#fff;text-decoration:none"><?php echo $unlocked;?></a>
</div>
</div>
</div>
</div>
